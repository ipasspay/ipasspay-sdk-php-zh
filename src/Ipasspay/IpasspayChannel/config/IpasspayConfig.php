...
class IpasspayConfig
{
    ...
    const ENV_CONFIG = [
        ...
        'sandbox'=>[
            ...
            "direct_pay_url" => "https://flamingo.service.qifanonline.com/gateway/OpenApi/onlinePay",
            "redirect_pay_url" => "https://flamingo.service.qifanonline.com/gateway/Index/checkout",
            "query_order_url" => "https://flamingo.service.qifanonline.com/gateway/OpenApi/getOrderDetail",
            "query_order_list_url" => "https://flamingo.service.qifanonline.com/gateway/OpenApi/getOrderList",
            "refund_url" => "https://flamingo.service.qifanonline.com/gateway/OpenApi/refund",
            "cancel_refund_url" => "https://flamingo.service.qifanonline.com/gateway/OpenApi/cancelRefund",
            "upload_express_url" => "https://flamingo.service.qifanonline.com/gateway/OpenApi/uploadExpress",
        ],
    ];
    //------------------
