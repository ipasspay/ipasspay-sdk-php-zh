...
use Ipasspay\AirsecurecardChannel\service\AirsecurecardService;
    ...
    //对接airsecurecard的退款请求

    //可调用sdk完成加密和通讯。具体参数说明请参见api文档
    //注意：merchant_id、app_id、api_secret都在AirsecurecardConfig中进行配置，这里无需填写
    //使用sdk的话，timestamp无需考虑
    //使用sdk的话，签名和验签过程无需考虑
    $request_data['gateway_order_no']='11024995227413376';//airsecurecard订单号
    $refund_no=time().mt_rand(100,999);//退款流水号，此处只是模拟
    $request_data['refund_no']=$refund_no;
    $request_data['refund_amount']='1.00';//退款金额
    $request_data['refund_desc']='Test Refund';//退款原因，可选
    //------------------------------------
