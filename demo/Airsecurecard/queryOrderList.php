...
use Ipasspay\AirsecurecardChannel\service\AirsecurecardService;
    ...
    //对接airsecurecard的订单列表查询接口

    //可调用sdk完成加密和通讯。具体参数说明请参见api文档
    //注意：merchant_id、app_id、api_secret都在AirsecurecardConfig中进行配置，这里无需填写
    //使用sdk的话，timestamp无需考虑
    //使用sdk的话，签名和验签过程无需考虑
    $request_data['start_datetime']='2021-01-01 00:00:00';//开始时间YYYY-MM-DD HH:MM:SS
    $request_data['end_datetime']='2022-02-01 00:00:00';//结束时间YYYY-MM-DD HH:MM:SS
    $request_data['order_status']=2;//订单状态，具体取值参考api文档
    $request_data['page']=2;//页码，可选
    //------------------------------------
